...
class Main < Gosu::Window
	...
	def update
		...
		@time = TIME - Gosu::milliseconds / (1000)
	end
	...
	private
		...
		def game_over_screen
			...
			@font.draw("Score: #{@player.score}", 370, height/3 + 150, 4, 1.0, 1.0, 0xff_ff0000)
			@font.draw("GAME OVER", 300, height/3, 4, 2.0, 2.0, 0xff_ff0000)
		end
end
